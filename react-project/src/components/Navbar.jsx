        ...
        <header className='w-full bg-white md:bg-trasparent fixed top-0 left-0 right-0'>
            <nav className={`py-4 lg:px-14 px-4 ${isSticky ? "stickey top-0 left-0 right-0 border-b bg-white duration-300" : ""}`}>
                <div className='flex justufy-betwen items-center text-base gap-8'>
                    ...
                    alt="" className='w-10 inline-block items-center'></img>
                    ...
                    <ul className='md:flex space-x-12 hidden'>
                        {
                            ...
                            key={path} className='block cursor-pointer text-base text-gray900 hover:text-bradPrimary 
                    ...
                    <div className='space-x-12 hidden lg:flex items-center'>
                        ...
                        <button className='bg-bradPrimary text-white py-2 px-4 transition-all duration-300
                ...
                {
                            navItems.map(({link, path}) => <link to={path} spy={true} smooth={true} offset={-100}
                            key={path} className='block text-base text-white hover:text-bradPrimary
                            first:font-medium'>{link}</link>)
                        }
                </div>
            </nav>
