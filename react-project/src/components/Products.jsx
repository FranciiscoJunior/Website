...
import aboutImg from '../assets/mobile-icons-login.png'
                ...
                <div className='md:w-11/12 mx-auto flex flex-col md:flex-row justify-between items-center gap-12'>
                    <div>
                        ...
                        <div className='md:w-2/3 mx-auto'>
                            <div>
                                <p className='md:w-4/5 text-sm text-neutralGrey mb-8 leading-7'>Maecenas dignissim justo eget nulla rutrum molestie. Maecenas lobortis sem dui, vel
                                ...
                                augue ultrices, quis tristique nulla sodales. Suspendisse eget lorem eu turpis vestibulum pretium.
                                ...
                                <div>
                                    <div className="flex items-center gap-8 flex-wrap">
                                        <img src="../assets/p1.png" alt="" className="cursor-pointer"/>
                                        <img src="../assets/p2.png" alt="" className="cursor-pointer"/>
                                        <img src="../assets/p3.png" alt="" className="cursor-pointer"/>
                                        <img src="../assets/p4.png" alt="" className="cursor-pointer"/>
                                        <img src="../assets/p5.png" alt="" className="cursor-pointer"/>
                                        <img src="../assets/p6.png" alt="" className="cursor-pointer"/>
